        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-lg-12">
                    ...
                    <OwlCarousel className="owl-theme" responsive={responsive} autoplay={true} autoplayHoverPause={true}autoplayTimeout={2500} loop={true} margin={10} nav={true} dots={false}>
