                    ...
                    <div className="project-desc">
                        <div className="project-details-text">
                            ...
                            <blockquote className="box-shadow">
                                ...
                                touchpoints for offshoring. Capitalize on low hanging fruit to identify a ballpark value
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div className="pro-deta-list">
                                        <ul>
                                            ...
                                            <li><i><AiOutlineCheckCircle/></i> Run fast familie lor separat.</li>
                                            <li><i><AiOutlineCheckCircle/></i> Best gym un myth por.</li>
                                            <li><i><AiOutlineCheckCircle/></i> Scientie musica sport etc li.</li>
