			...
			<div className="row">
					...
					<div className="box-shadow">
						...
						{FaqsData.map((data, index) => (
									...
									className={index == 0 ? "list-group-item list-group-item-action active" : "list-group-item list-group-item-action"}
									 id="list-home-list1"
									data-toggle="list" href={"#list" + index} role="tab"
				...
				<div className="col-md-8 col-sm-12 col-12">
					<div className="tab-content" id="nav-tabContent">
							...
							{FaqsData.map((data, index) => (
									<div className={ index == 0 ? "tab-pane fade show active" :  "tab-pane fade"} id={"list" + index} role="tabpanel"
										...
										<div className="accordion-wrapper">
											<div id={"accordion" + index}>
												{data.data.map((data1,index1) => (
																...
																<div className="card-header box-shadow" id={"heading" + index}>
																	<h5 className="mb-0">
																		<a className="collapsed " role="button" data-toggle="collapse"
																			data-target={"#collapse" + index + index1} aria-expanded="false" 
																			aria-controls={"#collapse" + index + index1}>{data1.heading}</a>
																	</h5>
																</div>
																<div id={"collapse"  + index + index1} className="collapse" aria-labelledby={"heading" + index}
