				...
				<div className="col-lg-6 col-md-12 col-sm-12 col-12">
					<div className="shop-details-info">
						...
						<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempore incidunt possimus
							blanditiis debitis dolore nobis non rem vel velit molestias ea minima repellat, officia
							maxime obcaecati et asperiores fugit nam?</p>
						<div className="quenty-btn-area">
							<div className="number-input">
								<form action="#" id="number-box">
									<input type="number" className="form-control " min="1" max="10" placeholder="Number" />
								</form>
							</div>
							<div className="add-btn"> <Link to="/cart" className="btn btn-theme btn-shop">Add TO CART</Link>
							</div>
						</div>
