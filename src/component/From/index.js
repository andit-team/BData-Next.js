  ...
  <>
        <div className="form-group">
          { props.label && (<label>{props.label}</label>)}
            ...
            {(()=>{ 
                    if(props.tag === 'input'){
                        return <input type={props.type} name={props.name} placeholder={props.placeholder} className={props.classes} />
                    }else if(props.tag === 'textarea'){
                        return  <textarea name={props.name} cols="30" rows="7" placeholder={props.placeholder} className={props.classes} required/>
                    }
